...
export default function Home() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <header className="bg-[#1a4fc4] text-white px-6 py-4 flex items-center justify-between shadow-sm">
        ...
        <Link
          href="/login"
          className="bg-white text-[#2b6ef5] font-semibold text-sm px-5 py-2 rounded-full hover:bg-gray-100 transition"
        >
          Get Started
        </Link>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center bg-[#f0f2f5]">
        <div className="w-24 h-24 bg-[#2b6ef5] rounded-full flex items-center justify-center mb-6 shadow-lg">
        ...
        <Link
          href="/login"
          className="flex items-center gap-2 bg-[#2b6ef5] hover:bg-[#2563eb] text-white font-semibold px-8 py-4 rounded-full text-lg shadow-md transition"
        >
